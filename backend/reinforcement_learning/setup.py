...
def discretize_state(game_state):
    ...
    ball_x_bin = game_state.ball_x_grid
    ball_y_bin = game_state.ball_y_grid
    paddle_x_bin = game_state.paddle_x_grid
    paddle_y_bin = config.GRID_HEIGHT - config.PADDLE_HEIGHT_GRID
